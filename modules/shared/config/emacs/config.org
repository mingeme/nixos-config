...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "mingeme"
    user-mail-address "heminghu00@126.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/xming/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/xming/bin" "/profile/bin" "/Users/xming/.npm-packages/bin" "/Users/xming/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
